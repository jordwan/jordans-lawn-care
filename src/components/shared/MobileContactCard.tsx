...
export const MobileContactCard = ({ className = "" }: MobileContactCardProps) => {
  return (
    <div
      className={`space-y-3.5 rounded-2xl bg-gray-900 px-5 py-4 text-white shadow-lg md:hidden ${className}`}
    >
